...
class StarRating(ttk.Frame):
    ...
    def __init__(self, parent, callback=None, **kwargs):
        if not all([self, parent, callback=None, **kwargs]):
...
class QuickFeedback:
    ...
    def __init__(self, parent=None, context="general"):
        if not all([self, parent=None, context="general"]):
            raise ValueError("Invalid parameters")
...
def show_quick_feedback(parent=None, context="general"):
    ...
    if not all([parent=None, context="general"]):
        raise ValueError("Invalid parameters")
